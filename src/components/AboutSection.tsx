  ...
  return (
    <section id="about" className="py-20">
      <div className="section-container">
        ...
        <div className="glass p-8 md:p-12 rounded-2xl max-w-5xl mx-auto scroll-reveal">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              <h3 className="text-2xl font-bold mb-4 scroll-reveal">Who I Am</h3>
              ...
              <div className="mt-6">
                <h3 className="text-xl font-semibold mb-3 scroll-reveal">My Journey</h3>
                <div className="space-y-4">
                  <div className="glass-card p-4 rounded-lg scroll-reveal">
            ...
            <div className="lg:col-span-1">
              <h3 className="text-2xl font-bold mb-4 scroll-reveal">Skills</h3>
              <div className="space-y-6">
                {skills.map((skillGroup, index) => (
                  <div key={index} className="glass-card p-5 rounded-lg scroll-reveal" style={{ transitionDelay: `${index * 100}ms` }}>
